...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header"><i class="bi bi-person-plus me-2"></i>Member Information</div>
            <div class="card-body">
                @if($errors->any())
                ...
                <form method="POST" action="{{ route('admin.members.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4 d-flex gap-2">
                        <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg me-1"></i>Create Member</button>
